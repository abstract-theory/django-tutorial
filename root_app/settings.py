...
ROOT_TEMPLATES_PATH = os.path.join(ROOT_APP_DIR, "templates")

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ROOT_TEMPLATES_PATH, ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static_files') # path of collected static files
STATICFILES_DIRS = (
    os.path.join(ROOT_APP_DIR, 'static'),
)
